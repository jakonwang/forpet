<?php /* Smarty version 2.6.30, created on 2017-02-27 22:58:28
         compiled from bkWanderingClues.tpl */ ?>
<!DOCTYPE html>
<html lang="en">
<head>
<meta charset="utf-8">
    ...
    <div class="row">
      <div class="col-md-12">
        <table class='table table-hover table-bordered'>
          ...
          <tbody>
          <?php if ($this->_tpl_vars['cluesList']): ?>
          <?php $_from = $this->_tpl_vars['cluesList']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }$this->_foreach['name'] = array('total' => count($_from), 'iteration' => 0);
...
?>
            <tr>
              ...
              <td><?php echo $this->_tpl_vars['item']->pnickname; ?>
</td>
...
'><span class='glyphicon glyphicon-eye-open' title='查看详情'></span></a>
                <a href="bkWanderingClues.php?action=deleteOneClue&id=<?php echo $this->_tpl_vars['item']->id; ?>
