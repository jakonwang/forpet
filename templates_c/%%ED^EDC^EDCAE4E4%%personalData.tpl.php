<?php /* Smarty version 2.6.30, created on 2017-02-27 16:23:45
         compiled from my/personalData.tpl */ ?>
<!DOCTYPE html>
<html lang="en">
<head>
	<meta charset="UTF-8">
...
<body id='my-setting'>
	...
	<main id="personal-data">
		<ul>
			<li class='personal-img'><a href="##">头像<img src="<?php echo $this->_tpl_vars['headimgurl']; ?>
" alt=""></a></li>
			<li><a href="##">昵称<span><?php echo $this->_tpl_vars['nickname']; ?>
</span></a></li>
			<li><a href="##">寻宠号<span><?php echo $this->_tpl_vars['id']; ?>
</span></a></li>
			<li><a href="##">寻宠认证</a></li>
			<li><a href="##">二维码</a></li>
			<li><a href="##">性别<span><?php echo $this->_tpl_vars['sex']; ?>
</span></a></li>
			<li><a href="##">年龄<span>12</span></a></li>
			<li><a href="##">城市<span><?php echo $this->_tpl_vars['country']; ?>
