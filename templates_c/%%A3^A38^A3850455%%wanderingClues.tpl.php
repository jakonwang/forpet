<?php /* Smarty version 2.6.30, created on 2017-03-11 20:34:04
         compiled from forpet/wanderingClues.tpl */ ?>
<!DOCTYPE html>
<html lang="en">
<head>
	<meta charset="UTF-8">
...
<body>
	...
	<main id='wandering-clues'>
		<ul>
		<?php if ($this->_tpl_vars['allClues']): ?>
		<?php $_from = $this->_tpl_vars['allClues']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
...
...</div>
				<div class="pic">
					<a href="wanderingClues.php?action=detail&id=<?php echo $this->_tpl_vars['item']->id; ?>
">
...
/js/wanderingClues.js'></script>
	<!--S 发布按钮-->
	<script src='<?php echo @ROOT_URL; ?>
/js/release.js'></script>
	<script src='<?php echo @ROOT_URL; ?>
/js/wanderAjax.js'></script>
</body>
</html>