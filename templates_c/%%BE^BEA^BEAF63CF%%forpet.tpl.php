<?php /* Smarty version 2.6.30, created on 2017-04-18 20:54:31
         compiled from forpet/forpet.tpl */ ?>
<!DOCTYPE html>
<html lang="en">
<head>
	<meta charset="UTF-8">
...
/images/for_pet/clueBg.png" alt="">
		...
		<a href="adopt.php?action=show" id="adopt">
			<img src="<?php echo @ROOT_URL; ?>
/images/for_pet/adoptBg.png" alt="">
			<div>
				<h2>--领养--</h2>
				<h3>Ta需要一个家</h3>
			</div>
		...
		<a href="retrieve.php?action=show" id="retrieve">
			<img src="<?php echo @ROOT_URL; ?>
/images/for_pet/retrieverBg.png" alt="">
			<div>
				<h2>--寻回--</h2>
				<h3>帮我找回Ta</h3>
			</div>
