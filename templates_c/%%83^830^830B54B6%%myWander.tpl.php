<?php /* Smarty version 2.6.30, created on 2017-02-27 17:18:08
         compiled from my/myWander.tpl */ ?>
<!DOCTYPE html>
<html lang="en">
<head>
	<meta charset="UTF-8">
...
<body>
	...
	<main id='myWander'>
		<ul>
		<?php if ($this->_tpl_vars['wanderList']): ?>
			<?php $_from = $this->_tpl_vars['wanderList']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
    foreach ($_from as $this->_tpl_vars['key'] => $this->_tpl_vars['item']):
?>
			<li class='item'><a href="<?php echo @ROOT_URL; ?>
/wanderingClues.php?action=detail&id=<?php echo $this->_tpl_vars['item']->id; ?>
">
