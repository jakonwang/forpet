<?php /* Smarty version 2.6.30, created on 2017-02-27 17:18:04
         compiled from my/myRetrieve.tpl */ ?>
<!DOCTYPE html>
<html lang="en">
<head>
	<meta charset="UTF-8">
	<title>寻宠--我的--我的寻回</title>
...
<body>
	<!--S header-->
	<header id='header'><span>我的寻回</span>
		<div id="return" onclick='javascript:history.back();'></div>
		<a href="retrieve.php?action=add" class='add-btn'></a>
	</header>
	<!--E header-->
	<!--S myRetrieve-->
	<main id='myRetrieve'>
		<ul>
		<?php if ($this->_tpl_vars['retrieveList']): ?>
			<?php $_from = $this->_tpl_vars['retrieveList']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
    foreach ($_from as $this->_tpl_vars['key'] => $this->_tpl_vars['item']):
?>
			<li class='item'><a href="<?php echo @ROOT_URL; ?>
/retrieve.php?action=detail&id=<?php echo $this->_tpl_vars['item']->id; ?>
">
