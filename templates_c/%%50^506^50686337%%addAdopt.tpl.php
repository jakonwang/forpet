<?php /* Smarty version 2.6.30, created on 2017-03-10 11:36:46
         compiled from forpet/addAdopt.tpl */ ?>
<!DOCTYPE html>
<html lang="en">
<head>
	<meta charset="UTF-8">
	<title>寻宠--领养中心--发布领养</title>
...
<body style='background:#f4f4f4'>
	<!--S clues-title-->
	<header id='header'>发布领养
		<div id="return" onclick='javascript:history.back();'></div>
	</header>
	<!--E clues-title-->
	<!--S add-clues-->
	<div class="add-adopt">
		<form action="adopt.php?action=add" method='post'>
			<div class="base pics">
				<h4>照片(宠物萌照),最多3张</h4>
...
/images/public_img/uploadBg.jpg" alt="" id='uploadImg'>
			...
			<div class="base">
				<div class="row">
					<label for="cateid" class='cate-title'>请选择您发布领养的宠物品种</label>
				</div>
				<div class="row">
...
"><?php echo $this->_tpl_vars['item']->category_name; ?>
				...
				<div class="row desc">
					<textarea name="description" placeholder="领养要求"></textarea>
				</div>
			</div>
			<div class="base">
				<div class="row">
