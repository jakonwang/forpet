	...
	<main id='expert-online'>
		...
		<div class="expert-contact">
			<ul>
				<li>
					<a href="">
						<img src="<{$smarty.const.ROOT_URL}>/images/service/pictureconsult.png" alt="">
						<p>图文咨询</p>
					</a>
				</li>
				<li>
					<a href="">
						<img src="<{$smarty.const.ROOT_URL}>/images/service/telephoneconsult.png" alt="">
						<p>电话咨询</p>						
					</a>
				</li>
				<li>
					<a href="">
						<img src="<{$smarty.const.ROOT_URL}>/images/service/selectdoctor.png" alt="">
						<p>选择医生</p>						
					</a>
				</li>
			</ul>
			...
			<figure class='experts-list-desc'>
				<a href="">
					<div class="experts-wrap">
						<img src="<{$smarty.const.ROOT_URL}>/images/thumb.jpg" alt="" class='experts-thumb'>
					</div>
