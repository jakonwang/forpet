...
<body id='for-pet-service'>
	...
	<main id='love-fund'>
		<ul>
			<li>
				<h2><a href="###"><img src="<{$smarty.const.ROOT_URL}>/images/thumb.jpg" alt="">ARB动物之友ARB动物之友</a></h2>
				<p>通过救助家养和野生动物，在学校和社区开展环保教育和倡导动物福利、立法、促进中国的环境保护事业。</p>
			</li>
			<li>
				<h2><a href="###"><img src="<{$smarty.const.ROOT_URL}>/images/thumb.jpg" alt="">ARB动物之友</a></h2>
