...
<body>
	<!--S header-->
	<header id='header'><span>领养详情</span>
	...
	<{if $oneAdopt}>
		<div class="publisher">
			<img src="<{$oneAdopt->headimgurl}>" alt="<{$oneAdopt->pnickname}>">
			<h2><{$oneAdopt->pnickname}></h2>
			<time><{$oneAdopt->pubdate}></time>
		</div>
		<div class="imgsrc">
		<{if $oneAdopt->imgsrc}>
			<{foreach from=$oneAdopt->imgsrc key=key item=item}>
				<img src="<{$item}>" alt="">
			<{/foreach}>
		<{/if}>
		</div>
		<div class="textdesc">
			<div class="row">
				<span>城市：</span>
				<p><{$oneAdopt->location}></p>
			</div>
			<div class="row">
				<span>宠物昵称：</span>
				<p><{$oneAdopt->nickname}></p>
			</div>
			<div class="row">
				<span>宠物年龄：</span>
				<p><{$oneAdopt->age}>岁</p>
			...
			<div class="row">
				<span>领养要求：</span>
				<p><{$oneAdopt->description}></p>
			</div>
			<div class="row">
				<span>联系人：</span>
				<p><{$oneAdopt->publisher}></p>
			</div>
			<div class="row">
				<span>联系方式：</span>
				<p><{$oneAdopt->telephone}></p>
			</div>
		</div>
	<{/if}>
	</main>
